  ...
  return (
    <BackgroundMusic>
      <div className="min-h-screen bg-gradient-blush relative overflow-hidden">
        ...
        {/* Love Letters */}
        <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="relative z-10 max-w-5xl mx-auto px-6 py-12">
          <LoveLetters />
        </motion.section>
        ...
        {/* Tic Tac Toe */}
        <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="relative z-10 max-w-3xl mx-auto px-6 py-12">
          <TicTacToe />
        </motion.section>
        ...
        {/* Video */}
        <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="relative z-10 max-w-4xl mx-auto px-6 py-12">
          <VideoSection />
        </motion.section>
